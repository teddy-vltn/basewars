...
BaseWars.SpawnMenu.Net = BaseWars.SpawnMenu.Net or {
    BuyEntity = "BaseWars_BuyEntity",
    AutoBuy = "BaseWars_AutoBuy"
}

BaseWars.Net.Register(BaseWars.SpawnMenu.Net.BuyEntity, { uuid = "string" })
BaseWars.Net.Register(BaseWars.SpawnMenu.Net.AutoBuy, { bool = "boolean", weapon = "string" })

BaseWars.SpawnMenu.EntityCountFormat = "BaseWars_EntityCount_%s"
...
function Player:GetEntityCount(class)
    return self:GetNWInt(string.format(BaseWars.SpawnMenu.EntityCountFormat, class))
end